   ...
   public class EmployeeValidation
    {
        ...
        static public ValidationResult UpdateNameValidation(EmployeeVal model)
        {
        ...
        static public ValidationResult UpdateUserNameValidation(EmployeeVal model)
        { 
        ...
        static public ValidationResult RegisterEmployeeValidation(EmployeeVal model)
        {
            var regexName = new Regex("^[a-zA-Z]+((['][a-zA-Z])?[a-zA-Z]*)*$");
            var regexUserName = new Regex(@"^[a-zA-Z]{1}[a-zA-Z0-9\._\-]{0,23}[^.-]$");
            ValidationResult result = new ValidationResult();
